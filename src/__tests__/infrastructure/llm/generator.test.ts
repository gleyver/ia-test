...
describe("ResponseGenerator", () => {
  ...
  beforeEach(() => {
    ...
    (ResponseGenerator as unknown as { instance?: ResponseGenerator }).instance = undefined;
  });
  ...
  describe("generate - sem contexto", () => {
    it("deve gerar resposta sem contexto", async () => {
      ...
      } as unknown as Awaited<ReturnType<typeof import("undici").request>>);
  ...
  describe("buildContext", () => {
    it("deve construir contexto a partir de documentos", () => {
      ...
      const context = (
        generator as { buildContext: (docs: typeof retrievedDocs) => string }
    ...
    it("deve retornar mensagem quando não há documentos", () => {
      ...
      const context = (generator as { buildContext: (docs: unknown[]) => string }).buildContext([]);
  ...
  describe("buildPrompt", () => {
    it("deve construir prompt com contexto e query", () => {
      ...
      const prompt = (
        generator as { buildPrompt: (query: string, context: string) => string }
      ).buildPrompt("Qual é o conteúdo?", "Contexto de teste");
