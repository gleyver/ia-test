...
vi.mock("@xenova/transformers", () => {
  const mockPipelineFunction = vi.fn().mockImplementation(async (text: string | string[]) => {
...
describe("EmbeddingGenerator", () => {
  ...
  beforeEach(() => {
    ...
    (EmbeddingGenerator as unknown as { instance?: EmbeddingGenerator }).instance = undefined;
  });
